...
public class RegistroDeVentas implements Serializable{
	...
	// es la lista de recibos guardad en las pociciones que corresponde a año, mes y dia del recibo
	...
	/**
	 * metodo que añade un recibo a la lista de recibos del dia
	 ...
	 * @return regresa un boolena que indica que se ha añadido el recibo con exito
	 */
	...
	/**
	 * metodo que sirve para verificar si el año ha sido creado, y esta lista para el uso
	 * de lo contrario creara los años necesarios para llegar hasta este.
