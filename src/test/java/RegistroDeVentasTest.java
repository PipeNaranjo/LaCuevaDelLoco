...
public class RegistroDeVentasTest extends TestCase {
	...
	public void adjuntarUnReciboTest() {
		...
		int cantidad = 3;
		ProductosInventario producto = new ProductosInventario(CODIGOBARRAS, NOMBREPRODUCTO,
				EMPRESA, 30, 19, 48800, 20, TIPO, 2500);
