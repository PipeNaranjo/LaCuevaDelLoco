...
public class ProductosVentas implements Serializable {
	...
	// variable donde se guarda la cantidad de unidades que hay del producto en
	// el inventario
	 ...
	 * 
	 * @param productoI
	 *            producto del inventario que se quiere comprar
	 * @param cantidad
	 ...
	 * 
	 * @param producto
	 *            la nueva instancia del producto
	 */
	 ...
	 * 
	 * @param cantidad
	 *            es la nueva cantidad de productos
	 */
	 ...
	 * 
	 * @param cantidad
	 *            es la cantidad a increntar en el inventario
	 */
	...
	/**
	 * metodo que permite disminuir la cantidad de unidades que va a comprar del
	 * producto
	 * 
	 * @param cantidad
	 *            es la cantidad a incrementar en el inventario
	 */
	 ...
	 * 
	 * @param comp
	 *            es la cadena con la que se desea comparar el nombre
	...
	/**
	 * metodo que sirve para comparar el nombre de con el nombre del producto
	 * del inventario entrante
	 * 
	 * @param comp
	 *            es el Objeto producto con el que se quiere comparar el nombre
	 * @return retorna el numero que indica si la cadena es mayor, igual o menor
	 */
